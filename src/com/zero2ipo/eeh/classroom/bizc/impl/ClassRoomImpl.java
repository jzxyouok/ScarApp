...
public class ClassRoomImpl extends IbatisBaseDao implements IClassRoomService {
 public final static String NAMESPACE="mobile.classroom.";
 public final static String COMMON="ClassRoom";
 ...
 public final static String FINDBYID=NAMESPACE+"find"+COMMON+"ById";
    ...
    public List<ClassRoomBo> findAllList(Map<String, Object> queryMap) {
        ...
        try {
            list = (List<ClassRoomBo>) this.queryAll(FINDALLLIST, queryMap);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public ClassRoomBo findById(String id){
        ...
        try {
            ...
            queryMap.put("id", id);
            bo = (ClassRoomBo) this.query(FINDBYID, queryMap);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return bo;
