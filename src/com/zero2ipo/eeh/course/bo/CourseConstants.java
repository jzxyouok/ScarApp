...
public class CourseConstants {
   ...
   public static final int  SEAT_TYPE_1=1;//培优座位表
   public static final String  SEAT_TYPE_0_NAME="日常座次";//日常座位表
   public static final String  SEAT_TYPE_1_name="培优座次";//培优座位表
