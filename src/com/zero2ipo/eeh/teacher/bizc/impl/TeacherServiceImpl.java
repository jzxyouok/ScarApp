...
public class TeacherServiceImpl extends IbatisBaseDao implements ITeacherService {
    public final static String NAMESPACE="mobile.Teacher.";
    ...
    public boolean delete(String ids) {
        ...
        try {
            ...
            e.printStackTrace();
            BaseLog.e(this.getClass(), "del_Teacher 删除出错", e);
    ...
    public List<TeacherBo> findAllList(Map<String, Object> queryMap) {
        ...
        try {
            list = (List<TeacherBo>) this.queryAll(FINDALLLIST, queryMap);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public TeacherBo findById(String id){
        ...
        try {
            ...
            queryMap.put("id", id);
            bo = (TeacherBo) this.query(FINDBYID, queryMap);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return bo;
