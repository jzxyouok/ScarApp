 ...
 */
@Service("TimeService")
public class TimeServiceImpl extends IbatisBaseDao implements ITimeService {
    public final static String NAMESPACE="mobile.Time.";
    ...
    public boolean delete(String ids) {
        ...
        try {
            ...
            e.printStackTrace();
            BaseLog.e(this.getClass(), "del_Time 删除出错", e);
    ...
    public List<TimeBo> findAllList(Map<String, Object> queryMap) {
        ...
        try {
            list = (List<TimeBo>) this.queryAll(FINDALLLIST, queryMap);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public TimeBo findById(String id){
        ...
        try {
            ...
            queryMap.put("id", id);
            bo = (TimeBo) this.query(FINDBYID, queryMap);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return bo;
