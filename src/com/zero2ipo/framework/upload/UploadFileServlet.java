 ...
 * All Rights Reserved
 */
package com.zero2ipo.framework.upload;
...
public class UploadFileServlet extends HttpServlet {
	...
	private static String baseDir = "/web/upload/article_img/";//上传文件存储目录
	...
	public void init(ServletConfig config) throws ServletException {
		...
		/*获取文件上传存储的相当路径*/
		if (StringUtils.isBlank(baseDir)) baseDir = "/web/upload/article_img/";
